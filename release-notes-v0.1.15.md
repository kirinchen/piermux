...
- **Linux 桌面(Ubuntu / Linux Mint,x86_64)**
  - `piermux_0.1.15_amd64.deb` — `sudo apt install ./piermux_0.1.15_amd64.deb`(相依 `libwebkit2gtk-4.1-0`、`libgtk-3-0`,Ubuntu 22.04+ / Mint 21+ 內建)
  - `piermux_0.1.15_amd64.AppImage` — `chmod +x` 後直接執行,免安裝
