...
- **M2a setup ✓(2026-05-13,NOTES D-15)**:Android Studio + NDK r27d (27.3.13750724) + JDK 21 + `.cargo/config.toml` + `gen/android/` scaffold 都到位,`cargo check --target aarch64-linux-android` 1m01s 全鏈路過。下一步:接實機 `npm run tauri android dev` → 後續開 EPIC-002 對齊 SPEC §8 M2b..M2e
